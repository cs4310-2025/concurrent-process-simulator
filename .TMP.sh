...
# FCFS
java -cp bin com.simulator.injector.ProcessInjector --workload ../workloads/workload.txt | java -cp bin com.simulator.core.CPUSimulator --cores 1 --scheduler FCFS --ipc pipe --output results_fcfs.csv

# SJF
java -cp bin com.simulator.injector.ProcessInjector --workload ../workloads/workload-sjf.txt | java -cp bin com.simulator.core.CPUSimulator --cores 1 --scheduler SJF --ipc pipe --output results_sjf.csv

# PRIO
java -cp bin com.simulator.injector.ProcessInjector --workload ../workloads/workload-prio.txt | java -cp bin com.simulator.core.CPUSimulator --cores 1 --scheduler PRIORITY --ipc pipe --output results_prio.csv
